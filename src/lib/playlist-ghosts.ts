...
function prettyLane(title: string): string | null {
  ...
  if (t.includes("always find")) return "find";
  if (t.includes("shiny")) return "shiny";
...
function promLane(title: string): string | null {
  ...
  if (t.includes("manual") || (t.includes("chaos") && !t.includes("swoon"))) return "manual";
  if (t.includes("helicopter") || t.includes("timeshare") || t.includes("time share")) return "ad";
  if (t.includes("elevation") || t.includes("elevator")) return "elevate";
  return "prom";
}
