...
const COPY_LANES: { x: number; y: number; align: CanvasTextAlign; wide: number }[] = [
  { x: 0.5, y: 0.24, align: "center", wide: 0.62 },
  { x: 0.08, y: 0.42, align: "left", wide: 0.4 },
  { x: 0.92, y: 0.38, align: "right", wide: 0.4 },
  { x: 0.5, y: 0.58, align: "center", wide: 0.68 },
  { x: 0.1, y: 0.56, align: "left", wide: 0.38 },
  { x: 0.9, y: 0.6, align: "right", wide: 0.38 },
];
...
export function RoseVortex({
  ...
  useEffect(() => {
    ...
    const draw = (now: number) => {
      ...
      if (kind !== "void" && kind !== "remember" && kind !== "vow" && kind !== "recall" && kind !== "obay" && kind !== "copter" && kind !== "stillhot" && kind !== "firewall" && kind !== "allocate" && kind !== "wolf" && kind !== "current" && kind !== "sweetie" && kind !== "halo" && kind !== "choir" && kind !== "badend" && kind !== "manual" && kind !== "shiny" && kind !== "timeshare" && kind !== "elevate" && kind !== "shell") {
