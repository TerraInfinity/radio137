...
//#endregion
//#region server/middleware/html-cache.ts
/**
...
function isPrivatePath(path) {
	return path === "/desk" || path.startsWith("/desk/") || path === "/login" || path.startsWith("/login/") || path === "/logout" || path.startsWith("/api/") || path.startsWith("/auth/");
}
