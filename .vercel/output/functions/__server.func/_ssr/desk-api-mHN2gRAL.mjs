...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-api-mHN2gRAL.js
...
var listCatalogEdits = createServerFn({ method: "GET" }).handler(listCatalogEdits_createServerFn_handler, async () => {
	const { listEdits, listStationEdits } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var hideStationTrack = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => trackRef.parse(input)).handler(hideStationTrack_createServerFn_handler, async ({ context, data }) => {
	const { hideTrack } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var restoreStationTrack = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => trackRef.parse(input)).handler(restoreStationTrack_createServerFn_handler, async ({ context, data }) => {
	const { restoreTrack } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var addStationTrack = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => object({
	...
	const { addTrack } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var patchStationTrack = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => object({
	...
	const { patchTrack } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var reorderStationTracks = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => object({
	...
	const { reorderTracks } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
...
var deleteStationFile = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => object({
	...
	const { markDeletedR2, hideTrack } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var saveStation = createServerFn({ method: "POST" }).middleware([adminMiddleware]).validator((input) => object({
	...
	const { upsertStation } = await import("./catalog-edits.server-CwFXx2_o.mjs").then((n) => n.n);
	return {
...
var pingServices = createServerFn({ method: "GET" }).middleware([adminMiddleware]).handler(pingServices_createServerFn_handler, async () => {
	const { hubOrigin } = await import("./sso.server-Bm75pg7o.mjs").then((n) => n.m);
...
//#endregion
export { addStationTrack_createServerFn_handler, deleteR2Object_createServerFn_handler, deleteStationFile_createServerFn_handler, getRadioSession_createServerFn_handler, hideStationTrack_createServerFn_handler, listCatalogEdits_createServerFn_handler, listStationR2_createServerFn_handler, moveR2Object_createServerFn_handler, patchStationTrack_createServerFn_handler, pingServices_createServerFn_handler, reorderStationTracks_createServerFn_handler, restoreStationTrack_createServerFn_handler, saveStation_createServerFn_handler };
