...
import { D as durationOf } from "./catalog-DmckmNNR.mjs";
...
import { T as searchDial, _ as CoverArt } from "./router-BjRk-_wL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dial-search-B6qTAUXC.js
				...
				children: results.songs.map(({ track, channel, copies }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "hidden font-mono text-[11px] tabular-nums text-subtle sm:inline",
