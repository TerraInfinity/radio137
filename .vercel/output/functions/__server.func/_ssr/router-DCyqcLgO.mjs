...
import { g as usePlayerStore, h as stationSkin, o as getSong, r as getChannel } from "./player-store-Dz5TRk6B.mjs";
import { n as formatClock, t as cn } from "./cn-CyOQLR37.mjs";
...
import { i as hasGateSessionMarker, t as auth } from "./server-C_ckUO6q.mjs";
...
import { i as listStationEdits, r as listEdits, t as addTrack } from "./catalog-edits.server-CwFXx2_o.mjs";
import { a as sanitizeUploadName, n as putR2Object, r as r2Configured, t as defaultPrefixForSlug } from "./r2.server-c_pO0NX7.mjs";
import { a as logoutLocation, c as r2Configured$1, d as requireAdmin, f as resolveRadioUser, h as isAdminEmail, i as hubOrigin, l as readNextFromCookie, n as clearSsoCookie, o as mintNextCookie, p as safeNext, r as exchangeSsoCode, s as mintSsoCookie, t as clearNextCookie, u as requestOrigin } from "./sso.server-Bm75pg7o.mjs";
import { a as Pause, i as Play, n as SkipForward, o as ChevronUp, s as ChevronDown, t as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/desk-api-DWQVxC1e.js
...
var radioSessionMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { resolveRadioUser, r2Configured, envLamps } = await import("./sso.server-Bm75pg7o.mjs").then((n) => n.m);
	return next({ context: {
...
var adminMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireAdmin, r2Configured, envLamps } = await import("./sso.server-Bm75pg7o.mjs").then((n) => n.m);
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DCyqcLgO.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "The green lamp is on. Default begins the clock. After this visit, this tab resumes wherever you left the dial. Uncheck the lamp if you want silence on arrival."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
					className: "mt-6 inline-flex h-11 items-center gap-2 font-mono text-[11px] uppercase tracking-[0.14em] text-muted",
...
function MiniPlayer() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "fixed inset-x-0 bottom-0 z-40 border-t border-line bg-bg/95 pb-[max(0.5rem,env(safe-area-inset-bottom))] backdrop-blur-sm",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), !collapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: playing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pause, { className: "size-5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "size-5" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
...
var styles_default = "/assets/styles-CKyeZyd6.css";
var APP_NAME = "Radio";
...
var $$splitComponentImporter$8 = () => import("./routes-CKxP4D-X.mjs");
...
var $$splitComponentImporter$6 = () => import("./desk-Bp1mPZ3F.mjs");
var Route$12 = createFileRoute("/desk")({
	component: lazyRouteComponent($$splitComponentImporter$6, "component"),
	head: () => ({ meta: [{ title: "Station desk · Radio" }] })
});
var $$splitComponentImporter$5 = () => import("./library-CEpXrrmy.mjs");
var Route$11 = createFileRoute("/library")({
	component: lazyRouteComponent($$splitComponentImporter$5, "component"),
	head: () => ({ meta: [{ title: "Library · Radio" }] })
});
var $$splitComponentImporter$4 = () => import("./login-GdUn9Kcq.mjs");
...
var Route$9 = createFileRoute("/logout")({
	server: { handlers: {
		GET: async ({ request }) => {
			const { clearSsoCookie, logoutLocation } = await import("./sso.server-Bm75pg7o.mjs").then((n) => n.m);
...
var $$splitComponentImporter$2 = () => import("../_slug-BtU2P66P.mjs");
...
var $$splitComponentImporter$1 = () => import("./player-D1aho1uZ.mjs");
var Route$7 = createFileRoute("/player/")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	head: () => ({ meta: [{ title: "Player · Radio" }] })
});
var $$splitComponentImporter = () => import("../_id-B8CblB9k.mjs");
...
//#endregion
export { reorderStationTracks as _, useRadioUser as a, deleteR2Object as c, getRadioSession as d, hideStationTrack as f, pingServices as g, patchStationTrack as h, ssoLoginHref as i, deleteStationFile as l, moveR2Object as m, Route$6 as n, CoverArt as o, listStationR2 as p, Route$8 as r, addStationTrack as s, router_exports as t, desk_api_exports as u, restoreStationTrack as v, saveStation as y };
