...
import { c as init_dist_es, f as require_httpAuthSchemes, p as require_protocols$1, s as dist_es_exports$1 } from "./client-s3+[...].mjs";
...
var dist_es_exports = /* @__PURE__ */ __exportAll({ fromSSO: () => fromSSO });
//#endregion
...
var require_sso = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var packageInfo = { version: "3.997.43" };
	var k = "ref";
	var a = -1;
	var b = true;
	var c = "isSet";
